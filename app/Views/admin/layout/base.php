...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/admin/assets/css/plugins/dataTables.bootstrap4.min.css')?>">
        ...
        <div class="navbar-content scroll-div " >
            ...
            <div class="">
                <div class="main-menu-header">
                    <img class="img-radius" src="<?=base_url('public/admin/assets/images/user/avatar-2.jpg') ?>" alt="User-Profile-Image">
...
<!-- Required Js -->
<script src="<?= base_url('public/admin/assets/js/vendor-all.min.js') ?>"></script>
<script src="<?= base_url('public/admin/assets/js/plugins/bootstrap.min.js')?>"></script>
<script src="<?= base_url('public/admin/assets/js/ripple.js')?>"></script>
<script src="<?= base_url('public/admin/assets/js/pcoded.min.js')?>"></script>
<script src="<?= base_url('public/admin/assets/js/menu-setting.min.js')?>"></script>


<script src="<?= base_url('public/admin/assets/js/plugins/jquery.dataTables.min.js')?>"></script>
<script src="<?= base_url('public/admin/assets/js/plugins/dataTables.bootstrap4.min.js')?>"></script>
<!-- Apex Chart -->
<script src="<?= base_url('public/admin/assets/js/plugins/apexcharts.min.js')?>"></script>
<!-- custom-chart js -->
<script src="<?= base_url('public/admin/assets/js/pages/dashboard-main.js')?>"></script>
<script>
